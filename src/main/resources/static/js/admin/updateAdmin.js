...
$(function () {
    ...
    $('#updateAdmin').click(function () {
        ...
        $.ajax({
            ...
            dataType:'json',
            data: {
                admNo: $.trim($("#updateId").val()),
                admName:$.trim($("#updateAdmName").val()),
                admSex: $.trim($("#updateAdmSex").val()),
                admAge: $.trim($("#updateAdmAge").val()),
                admTel:$.trim($("#updateAdmTel").val()),
                admAddress: $.trim($("#updateAdmAddress").val())
            },
