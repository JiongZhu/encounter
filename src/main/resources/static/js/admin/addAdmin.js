...
$(function () {
    ...
    $('#addAdmin').click(function () {
        ...
        $.ajax({
            ...
            dataType:'json',
            data: {
                admNo: $.trim($("#addAdmNo").val()),
                admName:$.trim($("#addAdmName").val()),
                admPass: $.trim($("#addAdmPass").val()),
                confirmAdmPass: $.trim($("#confirmAdmPass").val()),
                admSex:$.trim($("#addAdmSex").val()),
                admAge: $.trim($("#addAdmAge").val()),
                admTel: $.trim($("#addAdmTel").val()),
                admAddress:$.trim($("#addAdmAddress").val())
            },
