    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="#"><i class="fa fa-shopping-basket"></i> <span>顾客需求信息</span></a></li>
                ...
                <li><a href="#"><i class="fa fa-user-tie"></i> <span>交易员个人信息</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
