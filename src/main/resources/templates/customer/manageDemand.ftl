    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="manageDemand"><i class="fa fa-shopping-basket"></i> <span>零件需求管理</span></a></li>
                <li><a href="manageCustomer"><i class="fa fa-user"></i> <span>顾客个人信息</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-graduation-cap"></i> 顾客需求信息</li>
            </ol>
        </section>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "aoColumns": [
                ...
                {
                    "mDataProp": "demPartquantity",
                    "sTitle": "需求数量",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
                {
                    "mDataProp": "demPartprice",
                    "sTitle": "零件总价",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
                {
                    "mDataProp": "demRefertime",
                    "sTitle": "需求提交时间",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
            ...
            "sAjaxSource": "/demand/showAll" //请求资源路径
        });
        $("div.toolbar").html("<div class='col-md-3 col-sm-4'><button class='btn btn-default btn-sm' id='btn_add' data-toggle='modal' data-target='#addModal'><i class='fa fa-fw fa-user-plus'></i></button> 添加需求</div>");
    });
</script>
</body>
</html>