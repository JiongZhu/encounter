    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="manageSupplier"><i class="fa fa-user-cog"></i> <span>供应商信息</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-graduation-cap"></i> 供应商信息管理</li>
            </ol>
        </section>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "sAjaxSource": "/supplier/showAll" //请求资源路径
        });
        $("div.toolbar").html("<div class='col-md-3 col-sm-4'><button class='btn btn-default btn-sm' id='btn_add' data-toggle='modal' data-target='#addModal'><i class='fa fa-fw fa-user-plus'></i></button> 添加供应商</div>");
    });
</script>
</body>
</html>