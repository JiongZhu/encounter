    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="manageCustomer"><i class="fa fa-users"></i> <span>顾客信息</span></a></li>
                ...
                <li class="active"><a href="manageAdmin"><i class="fa fa-user-shield"></i> <span>管理员信息</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-graduation-cap"></i> 管理员信息管理</li>
            </ol>
        </section>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">管理员编号</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addAdmNo"  placeholder="请输入管理员编号">
                            <label class="control-label" for="addAdmNo" style="display:none;"></label>
                        </div>
                    </div>


                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">管理员姓名</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addAdmName"  placeholder="请输入管理员真实姓名">
                            <label class="control-label" for="addAdmName" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="password" class="form-control" id="addAdmPass"  placeholder="请输入管理员登录密码">
                            <label class="control-label" for="addAdmPass" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="password" class="form-control" id="confirmAdmPass"  placeholder="请重复输入登录密码">
                            <label class="control-label" for="confirmAdmPass" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addAdmSex"  placeholder="请输入管理员性别">
                            <label class="control-label" for="addAdmSex" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addAdmAge"  placeholder="请输入管理员年龄">
                            <label class="control-label" for="addAdmAge" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addAdmTel"  placeholder="请输入管理员联系电话">
                            <label class="control-label" for="addAdmTel" style="display:none;"></label>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">家庭住址</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addAdmAddress"  placeholder="请输入管理员家庭住址">
                            <label class="control-label" for="addAdmAddress" style="display:none;"></label>
                        </div>
                    </div>
                    <!---------------------表单-------------------->
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input type="text" class="form-control" id="updateAdmName"  placeholder="请输入管理员真实姓名">
                            <label class="control-label" for="updateAdmName" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">性别</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="updateAdmSex"  placeholder="请输入管理员性别">
                            <label class="control-label" for="updateAdmSex" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">年龄</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="updateAdmAge"  placeholder="请输入管理员年龄">
                            <label class="control-label" for="updateAdmAge" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">联系电话</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="updateAdmTel"  placeholder="请输入管理员联系电话">
                            <label class="control-label" for="updateAdmTel" style="display:none;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">家庭住址</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="updateAdmAddress"  placeholder="请输入管理员家庭住址">
                            <label class="control-label" for="updateAdmAddress" style="display:none;"></label>
                        </div>
                    </div>
...
<script type="text/javascript" src="../js/admin/addAdmin.js"></script>
<script type="text/javascript" src="../js/admin/updateAdmin.js"></script>
<script type="text/javascript" src="../js/admin/deleteAdmin.js"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "sAjaxSource": "/admin/showAll" //请求资源路径
        });
