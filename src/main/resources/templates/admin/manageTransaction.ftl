    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="manageTransaction"><i class="fa fa-handshake"></i> <span>交易订单信息</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
        ...
        $('#example').DataTable({
            ...
            "aoColumns": [
                ...
                },
                {
                    ...
                    render: function() {
                        return[
                            '<button id="ViewDetails" type="button" class="btn btn-info btn-xs"><i class="fas fa-xs fa-eye"></i></button>&nbsp;&nbsp;&nbsp;'+
