    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="manageAdvice"><i class="fa fa-comments"></i> <span>交易建议信息</span></a></li>
                <li><a href="manageTransaction"><i class="fa fa-handshake"></i> <span>交易订单信息</span></a></li>
                <li><a href="manageTrader"><i class="fa fa-user-tie"></i> <span>交易员个人信息</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("div.toolbar").html("<div class='col-md-3 col-sm-4'><button class='btn btn-default btn-sm' id='btn_add' data-toggle='modal' data-target='#addModal'><i class='fa fa-fw fa-user-plus'></i></button> 添加交易建议</div>");
    });
</script>
</body>
</html>