    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="manageAccommdate"><i class="fa fa-cart-plus"></i> <span>零件供应管理</span></a></li>
                <li><a href="manageSupplier"><i class="fa fa-user-cog"></i> <span>供应商个人信息</span></a></li>
                <li class="active"><a href="manageAdvice"><i class="fa fa-comments"></i> <span>交易建议管理</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-graduation-cap"></i> 交易建议</li>
            </ol>
        </section>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "aoColumns": [
                ...
                {
                    "mDataProp": "advPartquantity",
                    "sTitle": "建议交易数量",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
                {
                    "mDataProp": "advPartprice",
                    "sTitle": "零件总价",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
                {
                    "mDataProp": "advCompletetime",
                    "sTitle": "建议形成时间",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
                {
                    ...
                    render: function() {
                        return[
                            '<button id="TableEditor" type="button" class="btn btn-success btn-xs"><i class="fas fa-xs fa-check-square"></i></button>'
                        ]
                    }
                }
            ],
            ...
            "sAjaxSource": "/advice/showAll" //请求资源路径
        });
    });
</script>
</body>
