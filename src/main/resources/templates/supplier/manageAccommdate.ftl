    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="manageAccommdate"><i class="fa fa-cart-plus"></i> <span>零件供应管理</span></a></li>
                <li><a href="manageSupplier"><i class="fa fa-user-cog"></i> <span>供应商个人信息</span></a></li>
                <li><a href="manageAdvice"><i class="fa fa-comments"></i> <span>交易建议管理</span></a></li>
                <li><a href="manageTransaction"><i class="fa fa-handshake"></i> <span>交易订单管理</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-graduation-cap"></i> 供应商供应信息</li>
            </ol>
        </section>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "aoColumns": [
                ...
                {
                    "mDataProp": "accPartquantity",
                    "sTitle": "供应数量",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
                {
                    "mDataProp": "accPartprice",
                    "sTitle": "零件总价",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
                {
                    "mDataProp": "accRefertime",
                    "sTitle": "供应时间",
                    "sDefaultContent": "",
                    "sClass": "center"
                },
            ...
            "sAjaxSource": "/accommdate/showAll" //请求资源路径
        });
        $("div.toolbar").html("<div class='col-md-3 col-sm-4'><button class='btn btn-default btn-sm' id='btn_add' data-toggle='modal' data-target='#addModal'><i class='fa fa-fw fa-user-plus'></i></button> 新增供应</div>");
    });
</script>
</body>
</html>